...
// All data: Apr 22, 2026 · Crisis Day 53
// Sources: Barchart, Pound Sterling Live, WSJ, Yahoo
//          Wikipedia, Carbon Brief
// Live prices fetched via open APIs at runtime.
// ═══════════════════════════════════════════════════
...
export const OIL_TIMELINE = [
  ...
  { date: "Apr 15", label: "D+46",    brent: 99.04, wti: 97.45, event: "US–Iran peace talks Day 2. Brent rebounds to $99. Gold hits $4,836 (+1.9%). DXY 98.31.", type: "positive",    day: 46 },
  { date: "Apr 22", label: "TODAY",   brent: 101.32, wti: 99.18, event: "Peace talks stall over Hormuz reopening terms. Brent ticks above $101. Gold $4,912. MYR weakens past 4.01.", type: "today",    day: 53 },
];
...
export const GOLD_TIMELINE = [
  ...
  { date: "Apr 15", price: 4836.16, note: "Peace talks Day 2" },
  { date: "Apr 22", price: 4912.50, note: "Talks stall — safe-haven demand resumes" },
];
...
export const FX_RATES = [
  { pair:"USD/MYR", rate:4.0150,  prev:3.9660, note:"MYR weakens past 4.01; BNM holding reserves",              trend:"up",   pegged:false },
  ...
  { pair:"USD/JPY", rate:153.80,  prev:152.30, note:"BOJ yield curve control tested; ¥1.7T subsidies",       trend:"up",   pegged:false },
  { pair:"EUR/USD", rate:0.9180,  prev:0.9250, note:"ECB stagflation warning; Netherlands TTF crisis",        trend:"up",   pegged:false },
  { pair:"USD/INR", rate:88.10,   prev:87.45,  note:"RBI intervention; Russia oil pivot partly protecting",  trend:"up",   pegged:false },
  { pair:"USD/PHP", rate:59.40,   prev:58.92,  note:"Historic low; BSP $4B intervention; state emergency",   trend:"up",   pegged:false },
  { pair:"USD/PKR", rate:284.00,  prev:281.00, note:"IMF emergency talks; severe import crisis",             trend:"up",   pegged:false },
  { pair:"USD/KRW", rate:1392.00, prev:1385.00,note:"BOK holding; 208-day reserves provide buffer",          trend:"up",   pegged:false },
  { pair:"USD/TWD", rate:33.60,   prev:33.20,  note:"CBC intervention; TSMC power risk weighing on TWD",     trend:"up",   pegged:false },
  { pair:"USD/IDR", rate:16580,   prev:16420,  note:"Partial buffer from Pertamina domestic production",     trend:"up",   pegged:false },
