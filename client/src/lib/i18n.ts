...
export const translations: Record<Language, Translation> = {
  ...
  en: {
    header: {
      subtitle: "REAL-TIME WAR ECONOMY INTELLIGENCE",
    ...
    navigation: {
      ...
      sanctions: "SANCTIONS",
      scrollTabs: "SCROLL TABS FOR ✈️ AIRLINES · ⛽ FUEL · 🚫 SANCTIONS"
    },
    oil: {
      title: "Oil & Energy Crisis",
  ...
  bm: {
    header: {
      subtitle: "RISIKAN EKONOMI PERANG MASA NYATA",
    ...
    navigation: {
      ...
      sanctions: "SEKATAN",
      scrollTabs: "TATAL TAB UNTUK ✈️ PENERBANGAN · ⛽ BAHAN API · 🚫 SEKATAN"
    },
    oil: {
      title: "Krisis Minyak & Tenaga",
    ...
    markets: {
      title: "Pasaran Kewangan",
      financial: "Kewangan",
      data: "Data"
    },
    newsfeed: {
      title: "Suapan Berita Langsung",
      dailyBriefing: "Taklimat Harian",
      reports: "laporan",
      lastRefreshed: "Terakhir disegarkan",
      liveUpdates: "KEMAS KINI LANGSUNG",
      fetching: "Mengambil berita terkini..."
    },
    currencies: {
      title: "Pertukaran Mata Wang",
  ...
  ar: {
    header: {
      subtitle: "معلومات اقتصاد الحرب في الوقت الفعلي",
    ...
    navigation: {
      ...
      sanctions: "العقوبات",
      scrollTabs: "مرر للتبديل ✈️ الطيران · ⛽ الوقود · 🚫 العقوبات"
    },
    oil: {
      title: "أزمة النفط والطاقة",
      brentCrude: "خام برنت",
      wtiCrude: "خام دبليو تي آي",
      perBarrel: "للبرميل",
  ...
  hi: {
    header: {
      subtitle: "रियल-टाइम युद्ध अर्थव्यवस्था खुफिया",
      crisisDay: "संकट दिवस"
    },
    navigation: {
      oil: "तेल और ऊर्जा",
      ...
      sanctions: "प्रतिबंध",
      scrollTabs: "टैब स्क्रॉल करें ✈️ एयरलाइन्स · ⛽ ईंधन · 🚫 प्रतिबंध"
    },
    oil: {
      title: "तेल और ऊर्जा संकट",
      brentCrude: "ब्रेंट क्रूड",
      wtiCrude: "डब्ल्यूटीआई क्रूड",
    ...
    hormuz: {
      title: "हॉर्मुज जलडमरूमध्य",
      straitStatus: "जलडमरूमध्य स्थिति",
      shipping: "शिपिंग"
    },
    markets: {
      title: "वित्तीय बाज़ार",
      financial: "वित्तीय",
      data: "डेटा"
    },
    newsfeed: {
      title: "लाइव न्यूज़ फ़ीड",
      dailyBriefing: "दैनिक ब्रीफिंग",
      reports: "रिपोर्ट",
      lastRefreshed: "अंतिम अपडेट",
      liveUpdates: "लाइव अपडेट",
      fetching: "नवीनतम समाचार प्राप्त कर रहे हैं..."
    },
    currencies: {
      title: "मुद्रा विनिमय",
      conversion: "रूपांतरण",
  ...
  fr: {
    header: {
      subtitle: "RENSEIGNEMENT ÉCONOMIQUE DE GUERRE EN TEMPS RÉEL",
    ...
    navigation: {
      ...
      sanctions: "SANCTIONS",
      scrollTabs: "FAIRE DÉFILER LES ONGLETS ✈️ AÉRIEN · ⛽ CARBURANT · 🚫 SANCTIONS"
    },
    oil: {
      title: "Crise du Pétrole et de l'Énergie",
    ...
    newsfeed: {
      ...
      fetching: "Récupération des dernières nouvelles..."
    },
    currencies: {
  ...
  es: {
    header: {
      subtitle: "INTELIGENCIA ECONÓMICA DE GUERRA EN TIEMPO REAL",
    ...
    navigation: {
      ...
      sanctions: "SANCIONES",
      scrollTabs: "DESPLAZAR PESTAÑAS ✈️ AÉREAS · ⛽ COMBUSTIBLE · 🚫 SANCIONES"
    },
    oil: {
      title: "Crisis de Petróleo y Energía",
  ...
  de: {
    header: {
      subtitle: "ECHTZEIT-KRIEGSWIRTSCHAFTS-NACHRICHTENDIENST",
      crisisDay: "KRISENTAG"
    },
    navigation: {
      oil: "ÖL & ENERGIE",
      ...
      scrollTabs: "TABS SCROLLEN ✈️ FLUG · ⛽ KRAFTSTOFF · 🚫 SANKTIONEN"
    },
    oil: {
      title: "Öl- und Energiekrise",
    ...
    newsfeed: {
      title: "Live-Nachrichten-Feed",
      dailyBriefing: "Tägliches Briefing",
      reports: "Berichte",
      lastRefreshed: "Zuletzt aktualisiert",
      liveUpdates: "LIVE-UPDATES",
      fetching: "Abrufen der neuesten Nachrichten..."
    },
    currencies: {
  ...
  ja: {
    ...
    navigation: {
      ...
      fuelprices: "燃料価格",
      sanctions: "制裁",
      scrollTabs: "タブをスクロール ✈️ 航空 · ⛽ 燃料 · 🚫 制裁"
    },
    oil: {
      title: "石油・エネルギー危機",
      brentCrude: "ブレント原油",
  ...
  tr: {
    header: {
      subtitle: "GERÇEK ZAMANLI SAVAŞ EKONOMİSİ İSTİHBARATI",
      crisisDay: "KRİZ GÜNÜ"
    },
    navigation: {
      ...
      scrollTabs: "SEKMELERİ KAYDIR ✈️ HAVAYOLLARI · ⛽ YAKIT · 🚫 YAPTIRIMLAR"
    },
    oil: {
      title: "Petrol ve Enerji Krizi",
    ...
    newsfeed: {
      ...
      fetching: "En son haberler alınıyor..."
    },
    currencies: {
      title: "Döviz Kuru",
      conversion: "Dönüşüm",
  ...
  ru: {
    header: {
      subtitle: "ВОЕННО-ЭКОНОМИЧЕСКАЯ РАЗВЕДКА В РЕАЛЬНОМ ВРЕМЕНИ",
    ...
    navigation: {
      ...
      sanctions: "САНКЦИИ",
      scrollTabs: "ПРОКРУТИТЕ ВКЛАДКИ ✈️ АВИАЦИЯ · ⛽ ТОПЛИВО · 🚫 САНКЦИИ"
    },
    oil: {
      title: "Нефтяной и Энергетический Кризис",
